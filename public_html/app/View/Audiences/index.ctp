<div class="audiences index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $audience['Audience']['id']), array(), __('Are you sure you want to delete # %s?', $audience['Audience']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
