<div class="media index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($media['CreatedBy']['id'], array('controller' => 'users', 'action' => 'view', $media['CreatedBy']['id'])); ?>
		</td>
		<td><?php echo h($media['Media']['modified']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($media['ModifiedBy']['id'], array('controller' => 'users', 'action' => 'view', $media['ModifiedBy']['id'])); ?>
		</td>
		<td class="actions">
